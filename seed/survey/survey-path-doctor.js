...
export const doctorPathGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      options: [
        { option_text: 'Fastest and most straightforward process — Saudi Prometric', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { gulf_preference: 2, exam_tolerance: 1, time_investment: -1 } },
        { option_text: 'Highest earning potential and prestige — Qatar or UAE', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { income_expectation: 2, gulf_preference: 2 } },
        { option_text: 'Better lifestyle and stability — UAE, Bahrain, or Oman', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { gulf_preference: 1, time_investment: 1 } },
        { option_text: 'I have specific connections or family — Kuwait', next_node_id: 'CALIB_EXAMS',
    ...
    },
    {
      ...
      options: [
        { option_text: 'I only speak English — UK or Ireland are my options', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { western_preference: 2, language_learning: 0, exam_tolerance: 2 } },
        { option_text: 'I am willing to learn a language — Germany is worth the effort', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { language_learning: 3, time_investment: 2, income_expectation: 1 } },
        { option_text: 'English-friendly with faster process — Malta', next_node_id: 'CALIB_EXAMS',
    ...
    },
    {
      ...
      options: [
        { option_text: 'USA — highest stakes, highest reward, most opportunities', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { western_preference: 3, exam_tolerance: 3, cost_tolerance: 3, income_expectation: 3, time_investment: 3 } },
        { option_text: 'Canada — good income, better work-life balance, IMG-friendly provinces', next_node_id: 'CALIB_EXAMS',
    ...
    },
    {
      ...
      options: [
        { option_text: 'Australia — larger market, specialist pathway, beach lifestyle', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { western_preference: 2, exam_tolerance: 2, time_investment: 2, income_expectation: 2 } },
        { option_text: 'New Zealand — smaller, quieter, streamlined process', next_node_id: 'CALIB_EXAMS',
    ...
    },
    {
      ...
      options: [
        { option_text: 'Government MOH hospital — job security, pension, structured career', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { egypt_stability: 3, income_expectation: -1, clinical_vs_admin: 1 } },
        { option_text: 'University hospital — academic career, research, teaching', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { egypt_stability: 2, research_academic_orientation: 3, income_expectation: -1 } },
        { option_text: 'Private sector — higher income, more autonomy, less security', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { egypt_stability: 1, income_expectation: 2, clinical_vs_admin: 1 } },
        { option_text: 'Military or Police medical services — distinct benefits and track', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { egypt_stability: 2, income_expectation: 1 } },
        { option_text: 'Pursue a postgraduate degree (Masters/MD) first', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { egypt_stability: 1, research_academic_orientation: 2, time_investment: 2 } },
        { option_text: 'Work with international NGOs operating in Egypt', next_node_id: 'CALIB_EXAMS',
    ...
    },
    {
      ...
      options: [
        { option_text: 'Global health policy and programs — WHO, UN agencies', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { humanitarian_orientation: 3, clinical_vs_admin: -2, research_academic_orientation: 1 } },
        { option_text: 'Humanitarian field work — MSF, Red Cross, crisis response', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { humanitarian_orientation: 3, clinical_vs_admin: 0, willingness_relocate: 2 } },
        { option_text: 'Global health research — publications, academia, think tanks', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { research_academic_orientation: 3, clinical_vs_admin: -1, language_learning: 1 } },
        { option_text: 'Health-tech and digital health — innovation and product roles', next_node_id: 'CALIB_EXAMS',
          axis_deltas: { clinical_vs_admin: -2, income_expectation: 2, research_academic_orientation: 1 } },
        { option_text: 'Pharmaceutical industry — clinical development, medical affairs', next_node_id: 'CALIB_EXAMS',
