...
export const doctorSpecialtyGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      options: [
        { option_text: 'Bones and joints', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Abdomen / general operations', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Brain and nervous system', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Heart and chest', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
      ],
    },
    {
      ...
      options: [
        { option_text: 'Catheter-based heart procedures', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { procedural_affinity: 1 } },
        { option_text: 'Image-guided minimally invasive procedures', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { lab_imaging_affinity: 1 } },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        { option_text: 'Internal medicine mysteries', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Neurological puzzles', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { diagnostic_puzzle_affinity: 1 } },
        { option_text: 'Infectious disease detective work', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { public_health_affinity: 1 } },
      ],
    },
    {
      ...
      options: [
        { option_text: 'Chronic disease management', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Geriatric care', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
      ],
    },
    {
      ...
      options: [
        ...
        { option_text: "Women's health / pregnancy", next_node_id: 'CALIB_LIFESTYLE',
    ...
    },
    {
      ...
      options: [
        { option_text: 'General pediatrics', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Pediatric cardiology', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { diagnostic_puzzle_affinity: 1 } },
      ],
    },
    {
      ...
      options: [
        { option_text: 'General psychiatry', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: {} },
        { option_text: 'Child and adolescent', next_node_id: 'CALIB_LIFESTYLE', axis_deltas: { pediatric_affinity: 1 } },
      ],
    },
    {
      ...
      options: [
        { option_text: 'Making hospitals safer and processes better', next_node_id: 'CALIB_LIFESTYLE',
          axis_deltas: { admin_systems_affinity: 2 } },
        { option_text: 'Advancing medical knowledge through research', next_node_id: 'CALIB_LIFESTYLE',
          axis_deltas: { research_academic_affinity: 3 } },
        { option_text: 'Population-level health, not individual patients', next_node_id: 'CALIB_LIFESTYLE',
          axis_deltas: { public_health_affinity: 3 } },
        { option_text: 'Technology and data in medicine', next_node_id: 'CALIB_LIFESTYLE',
    ...
    },
    {
      ...
      options: [
        { option_text: 'The science of diagnosis', next_node_id: 'CALIB_LIFESTYLE',
          axis_deltas: { diagnostic_puzzle_affinity: 1 } },
        { option_text: 'The art of patient relationships', next_node_id: 'CALIB_LIFESTYLE',
          axis_deltas: { acute_vs_longitudinal: -1 } },
        { option_text: 'The team and leadership side', next_node_id: 'CALIB_LIFESTYLE',
